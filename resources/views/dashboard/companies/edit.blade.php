    ...
    <form method="post" action="{{route('companies.update', $company->id)}}">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="nationality" class="form-control" placeholder="Location" value={{$company->nationality}}>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="email" class="form-control" id="inputPassword3" placeholder="Email" value={{$company->email}}>
                </div>
            </div>
          </div>
          <!-- /.card-body -->
