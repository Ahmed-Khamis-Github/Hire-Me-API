...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-edit"
            style="background-color:#082146fa !important">
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="" target="_blank" class="nav-link">{{-- to highlight the active page --}}
